...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
		...
		<body background="">
			<div align="center">
				...
				<div class="container" style="margin-top:50px; width:900px;" align="left">
			<div class="well">
			...
			<div class="container" style="width: 500px;">
				<form action="${pageContext.request.contextPath }/com/login.action" method="post" id="login" name="login">
					<h3 style="color: #802C59" align="center">论文文本查重系统</h3>
					<div class="control-group">
						<label style="font-size:18px;">登录帐号:</label>
						<input type="text" name="loginid" id="username" value="admin" style=" width: 283px;" maxlength="14" rel="tooltip" data-original-title="请输入您的登陆账号" data-placement="right"/>
					</div>
					
					<div class="control-group">
						<label style="font-size:18px">登录密码:</label>
						<input type="password" name="password" id="password" value="123456" style="width: 283px;" maxlength="30" rel="tooltip" data-original-title="请输入您的登录密码" data-placement="right"/>
					</div>
					<div class="control-group">
						<label style="font-size:18px">登录角色:</label>
					...
					<div class="control-group" style="margin-bottom:0px;">
						...
						<span class="add-on" style="border:0px;">
							...
							<button type="button" class="btn btn-info" style="margin-bottom: 10px; margin-left: 20px;width:167px;" onclick="toreg()">注     册</button>
						</div>
					</div>
				</form>
			</div>
					...
					window.location="./reg.jsp";
						...
						<div align="left" style="width:100%; border-top:1px #CCC solid; margin-top:10px;">
							<table style="width:100%;">
								<tr>
									<td align="left">Copyright &copy; 2016</td>
								</tr>
							</table>
						</div>
