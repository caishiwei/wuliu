...
<h2 class="contentTitle">添加 线路 信息</h2>
<div class="pageContent">
	<form method="post" action="${ctx}/sys/addLine.action" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this)">
				...
				<div>
					<table class="list nowrap itemDetail" addButton="添加中转站" width="100%">
						...
						<tbody>
							...
							<tr>
								<td>${item.name }</td>
								<td><a title="确实要删除这条记录吗?" target="ajaxTodo" href="${ctx}/sys/deleteOption.do?ids=${item.id}" >删除</a></td>
							</tr>
							</c:forEach>
						</tbody>
					</table>
