...
<h2 class="contentTitle">添加 ${operType } 信息</h2>
<div class="pageContent">
	<form method="post" action="${ctx}/sys/addSimpleUser.action" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this)">
		<input type="hidden" value="${operType}" name="userType"/>
		<div class="pageFormContent" layoutH="97">
			<table>
					...
					<tr>
						<td colspan="2"><dl>
							<dt>联系电话：</dt>
							<dd><input name="user.userPhone"  type="text"  class="phone required"/></dd>
							</dl></td>
					</tr>
					<tr>
						<td colspan="2"><dl>
