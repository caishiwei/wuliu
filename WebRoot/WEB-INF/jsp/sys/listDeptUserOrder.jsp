...
<form id="pagerForm" method="post" action="${ctx}/sys/queryDeptUserOrder.action">
	<input type="hidden" name="pageNum" value="" />
</form>

<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/sys/queryDeptUserOrder.action" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="${ctx}/sys/getDeptUserOrder.action?uid={sid_select}" target="navTab" rel="baseAdd" warn="请选择一条信息,点击需要修改的行" title="物流信息"><span>查看物流信息</span></a></li>
		</ul>
	</div>
