...
<form id="pagerForm" method="post" action="${ctx}/sys/querySimpleUser.action?s_userType=${operType}">
	<input type="hidden" name="pageNum" value="" />
</form>

<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/sys/querySimpleUser.action?s_userType=${operType}" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${ctx}/sys/add2SimpleUser.action?operType=${operType}" target="navTab"  rel="baseAdd" title="添加信息"> <span>添加</span></a></li>
