...
<h2 class="contentTitle">修改 ${modifybean.userType } 信息</h2>
<div class="pageContent">
	<form method="post" action="${ctx}/sys/updateSimpleUser.action" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this)">
		...
		<input type="hidden" value="${modifybean.userType }" name="userType">
		<div class="pageFormContent" layoutH="97">
			<table>
					...
					<c:if test="${operType != '用户' }">
					<tr>
						<td colspan="2"><dl>
							<dt>所在部门：</dt>
							<dd>
								 <select name="dept.id" class="" id="dddddd44543534534531">
...
$("#dddddd4454353453453").val("${modifybean.userType}");
$("#dddddd44543534534531").val("${modifybean.dept.id}");
</script>