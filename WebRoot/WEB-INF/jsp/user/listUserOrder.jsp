...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${ctx}/sys/add2MyOrder.action" target="navTab"  rel="baseAdd" title="寄件"> <span>寄件</span></a></li>
			<li><a class="edit" href="${ctx}/sys/getMyOrder.action?uid={sid_select}" target="navTab" rel="baseAdd" warn="请选择一条信息,点击需要修改的行" title="物流信息"><span>查看物流信息</span></a></li>
		</ul>
	</div>
